...
"initial condition x0'" 0.1 0 -2674135 true "" ""
...
This model demonstrates sensitive dependence on initial conditions in the behavior of the logistic map, x{t+1} = R x{t} (1 - x{t}), where x{t} is the value of x at time step t, and x{t+1} is the value of x at the next time step. x is always between 0 and 1.   R is a control parameter that ranges from 0 to 4.  

## HOW IT WORKS

## HOW TO USE IT

Use the sliders to set R, x{0}, and x{0}'.  Click on "setup" to draw the axes and the parabola representing the function y = R x (1 - x).  Click on "go" to do successive iterations of the logistic map.  
...
This model was developed by Melanie Mitchell. Copyright 2013 by Santa Fe Institute and Portland State University. This work is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 3.0 License. To view a copy of this license, visit http://creativecommons.org/licenses/by-nc-sa/3.0/ or send a letter to Creative Commons, 559 Nathan Abbott Way, Stanford, California 94305, USA.
@#$#@#$#@
default
true
0
