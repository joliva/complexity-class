...
to setup
  ...
  ask one-patch [sprout-bunnies initial-pop [set old false set shape "bunny2" set color white set size 4 disperse]]
end 
...
to-report how-many-to-hatch
  report birth-rate * count bunnies
end 

to disperse
  set size size * .98 set heading random 360 fd random-normal 5 5 set old false 
end 
