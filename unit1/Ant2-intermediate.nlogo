...
to setup
  ...
  [
    ...
    set color red
    set food-eaten 0
    set mode 0   ; 0 = foraging, 1 = going home to nest
  ]
  ; create nest
  ...
  [
    ifelse (mode = 0) [
      ...
      [
        ...
        ifelse (food-eaten > 100)
        [
          set color yellow
        ]
        [
          if (food-eaten > 50) [set color blue]
        ]
        set mode 1  ; return to nest
      ]
    ]
    [
      ; returning to nest
      ...
      forward random max-step-size
      if pcolor = orange [
        ; has returned to nest, start foraging again
        set mode 0
      ]
    ]
  ]
